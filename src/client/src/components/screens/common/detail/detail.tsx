...
const { default: QrImg } = require('./icons/qr-code.svg')
const { default: CopyImg } = require('./icons/copy.svg')
...
const DetailView = ({ string, stringFontSize, options, bottom }: IDetailViewProps) => {
    return (
        <StyledDetail>
            <StyledTop>
                <StyledString>
